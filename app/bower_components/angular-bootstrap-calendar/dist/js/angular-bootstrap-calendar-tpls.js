...
/***/ function(module, exports) {
	...
	module.exports = "<div\n  mwl-droppable\n  on-drop=\"vm.handleEventDrop(dropData.event, day.date, dropData.draggedFromDate)\"\n  class=\"cal-month-day {{ day.cssClass }}\"\n  ng-class=\"{\n    'cal-day-outmonth': !day.inMonth,\n    'cal-day-inmonth': day.inMonth,\n    'cal-day-weekend': day.isWeekend,\n    'cal-day-past': day.isPast,\n    'cal-day-today': day.isToday,\n    'cal-day-future': day.isFuture\n  }\">\n\n <span\n    class=\"pull-right\"\n    data-cal-date\n    ng-click=\"vm.calendarCtrl.dateClicked(day.date)\"\n    ng-bind=\"day.label\">\n  </span>\n\n <br><br> <div width=50px> <small\n    class=\"cal-events-num badge badge-gold\"\n    ng-show=\"day.badge4 > 0\"\n    ng-bind=\"day.badge4\">\n  </small><small\n    class=\"cal-events-num badge badge-purple\"\n    ng-show=\"day.badge3 > 0\"\n    ng-bind=\"day.badge3\">\n  </small>\n<small\n    class=\"cal-events-num badge badge-blue\"\n    ng-show=\"day.badge2 > 0\"\n    ng-bind=\"day.badge2\">\n  </small><small\n    class=\"cal-events-num badge badge-green\"\n    ng-show=\"day.badge1 > 0\"\n    ng-bind=\"day.badge1\">\n  </small><small\n    class=\"cal-events-num badge badge-grey\"\n    ng-show=\"day.badge0 > 0\"\n    ng-bind=\"day.badge0\">\n  </small>\n</div>  <div class=\"cal-day-tick\" ng-show=\"dayIndex === vm.openDayIndex && vm.view[vm.openDayIndex].events.length > 0 && !vm.slideBoxDisabled\">\n    <i class=\"glyphicon glyphicon-chevron-up\"></i>\n    <i class=\"fa fa-chevron-up\"></i>\n  </div>\n\n  <div id=\"cal-week-box\" ng-if=\"false\">\n    <span ng-bind=\"vm.calendarConfig.i18nStrings.weekNumber.replace('{week}', day.date.clone().add(1, 'day').isoWeek())\"></span>\n  </div>\n\n</div>\n";
	    ...
	    function getMonthView(events, viewDate, cellModifier) {
	      ...
	      while (day.isBefore(endOfMonthView)) {
	        ...
	        var cell = {
	          ...
	          events: monthEvents,
	          badgeTotal: 123,
	          badge0: getBadgeTotal(monthEvents, 0),
	          badge1: getBadgeTotal(monthEvents, 1),
	          badge2: getBadgeTotal(monthEvents, 2),
	          badge3: getBadgeTotal(monthEvents, 3),
	          badge4: getBadgeTotal(monthEvents, 4)
	        };
